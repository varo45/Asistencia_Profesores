...
class DataSource
{
    ...
    const HOST = 'PMYSQL135.dns-servicio.com:3306';

    const USERNAME = 'profesores';

    const PASSWORD = 'f36c0d6388963313095f349dabd4c2e9f730868e';

    const DATABASENAME = '7828181_Bezmiliana';
